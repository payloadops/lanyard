...
// Source: github.com/payloadops/plato/api/dal (interfaces: ProjectManager)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_project_db_client.go github.com/payloadops/plato/api/dal ProjectManager
//
