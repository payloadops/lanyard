...
// Source: github.com/payloadops/plato/api/dal (interfaces: PromptManager)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_prompt_db_client.go github.com/payloadops/plato/api/dal PromptManager
//
...
func (m *MockPromptManager) ListPromptsByProject(arg0 context.Context, arg1 string) ([]dal.Prompt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPromptsByProject", arg0, arg1)
	ret0, _ := ret[0].([]dal.Prompt)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPromptManagerMockRecorder) ListPromptsByProject(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPromptsByProject", reflect.TypeOf((*MockPromptManager)(nil).ListPromptsByProject), arg0, arg1)
}
