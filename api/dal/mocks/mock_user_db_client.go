...
// Source: github.com/payloadops/plato/api/dal (interfaces: UserManager)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_user_db_client.go github.com/payloadops/plato/api/dal UserManager
//
