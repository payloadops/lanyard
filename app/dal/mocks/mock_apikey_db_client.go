...
// Source: github.com/payloadops/plato/api/dal (interfaces: APIKeyManager)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_apikey_db_client.go github.com/payloadops/plato/api/dal APIKeyManager
//
