...
// Source: github.com/payloadops/plato/api/cache (interfaces: Cache)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_cache_client.go github.com/payloadops/plato/api/cache Cache
//
